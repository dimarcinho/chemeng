 ...
 * @author marci
 */
public class SourceTiled extends GameObject {
    
    private static final String TAG = SourceTiled.class.getName();

    public SourceTiled(float x, float y) {
        super(x,y,128,64);
    }
