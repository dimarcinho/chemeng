 ...
 * @author marci
 */
public class ChillerGraphicsComponent extends TiledGraphicsComponent {
    
    private static final String TAG = ChillerGraphicsComponent.class.getSimpleName();
    
    private TextureMapObject tmo;    
    private TextureRegion textureRegion;
    
    public ChillerGraphicsComponent(float x, float y){
        
        Texture texture = new Texture(Gdx.files.internal("img/chiller_320x320.png"));
