 ...
 * @author marci
 */
public class PermutadorTiled extends GameObject {
    
    private static String TAG = PermutadorTiled.class.getName();

    public PermutadorTiled(float x, float y) {
        super(x, y, 448, 128);
    }
