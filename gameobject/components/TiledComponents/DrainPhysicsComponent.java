 ...
 * @author marci
 */
public class DrainPhysicsComponent extends TiledPhysicsComponent {
    
    private static final String TAG = DrainPhysicsComponent.class.getName();

    private Vector2 input;    
    
    
    public DrainPhysicsComponent() {
        super(1, 0);
